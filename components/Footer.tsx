...
const Footer: React.FC<FooterProps> = ({ toggleChat }) => {
    return (
        <>
            ...
            <button
                onClick={toggleChat}
                className="fixed bottom-6 right-6 bg-gray-800 text-white p-4 rounded-full shadow-lg hover:bg-purple-600 transition-all duration-300 transform hover:scale-110 z-50"
