        ...
        <div className="w-full max-w-2xl mb-8">
            <form onSubmit={handleSearch} className="relative">
                <input
                    ...
                    className="w-full bg-gray-900 bg-opacity-50 text-white p-4 pl-12 rounded-full border-2 border-purple-500/50 focus:ring-2 focus:ring-purple-400 focus:outline-none transition backdrop-blur-sm"
                />
